...
public class GameFrame extends javax.swing.JFrame {
      ...
      private String player1House = selectedHouse;
      private String player1Bakod = selectedBakod;
      private JLabel houseImageLabel;
      private final String[] bakod = {"brick", "sand", "wiredF","fence"};

 public GameFrame(String selectedHouse) {
    ...
    setVisible(true);
     ...
     System.out.println("Selected house in GameFrame: " + selectedHouse);
    displayHouseImage();
  ...
  private void displayHouseImage() {
    ...
    JButton[] buttons = { next,back,Fence,brick,sandb,wired,save};
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 930, 250, 70));
    ...
    selectedBakod = bakod[bakodIndex];
   ...
   setBackground(new java.awt.Color(255, 215, 0));
    ...
    int save1 = this.save1;
           player1House = selectedHouse;
           player1Bakod = selectedBakod;
if (!selectedBakod.isEmpty() && save1 == 1) {
    Start_Player2 start2 = new Start_Player2(player1House, player1Bakod);
    start2.setVisible(true);
    this.dispose(); // Optional: close the current frame
} else if (selectedBakod.isEmpty() && save1 == 0) {
 ...
 if (save1 == 1) {
        ...
        if (x == 0) { // User chose "Yes"
            save1--;
            selectBakod(2);
            updateHouseImageBakod(wired, 2, selectedHouse);
        }
    ...
    private void sandbActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sandbActionPerformed
        ...
        if (x == 0) { // User chose "Yes"
            save1--;
        selectBakod(1);
        updateHouseImageBakod(sandb, 1 ,selectedHouse);
        }
    ...
    private void FenceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_FenceActionPerformed
       ...
       if (save1 == 1) {
        ...
        if (x == 0) { // User chose "Yes"
            save1--;
         selectBakod(3);
       updateHouseImageBakod(Fence, 3 ,selectedHouse);
        }
   ...
   if (save1 == 1) {
        ...
        if (x == 0) { // User chose "Yes"
            save1--;
         selectBakod(0);
       updateHouseImageBakod(brick, 0 ,selectedHouse);
        }
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        ...
        save1 (save1,  selectedHouse, selectedBakod);
         save1++;
        if (!selectedBakod.isEmpty()){
        JOptionPane.showMessageDialog(this, "Saved!");}else{
        JOptionPane.showMessageDialog(this, "Choose a Bakod First!");
        }
  ...
  public void save1 (int save1,  String selectedHouse, String selectedBakod){
     switch(save1){
     
         case 0:
           player1House = selectedHouse;
           player1Bakod = selectedBakod;
             System.out.println("Player 1 selected: House = " + player1House + ", Bakod = " + player1Bakod);
             System.out.println("Saved Player2 will now Select a House and Bakod");
...
private void updateHouseImageBakod(JButton selectedButton, int bakodIndex, String selectedHouse) {
    // Define a list of bakod images based on the selected house
    String[] bakodImages = {
        selectedHouse + "brick.png",
        selectedHouse + "sand.png",
        selectedHouse + "wiredF.png",
        selectedHouse + "fence.png"
    };

    // Default image path (if no specific bakod is selected)
    String imagePath = "/patibayanngbahay/pic/H_" + selectedHouse.charAt(1) + ".png"; // default
