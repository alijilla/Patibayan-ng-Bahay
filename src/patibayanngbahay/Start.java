...
public class Start extends javax.swing.JFrame {
  ...
  addClickSoundToButtons();     
   ...
   private void selectHouse(JButton selectedButton, int houseIndex) {
    ...
    selectedHouse = houses[houseIndex];
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 370, 250, 70));
    ...
    private void nextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextActionPerformed
        ...
        GameFrame game = new GameFrame(selectedHouse);
